...
class MaxLayer(Layer):
    ...
    def call(self,x):
        return K.argmax(x, axis=3) #keepdims=True)
...
class BilinearUpsampling(Layer):
    ...
    def __init__(self, upsampling=(2, 2), output_size=None, data_format=None, **kwargs):
        ...
        self.data_format = data_format #conv_utils.normalize_data_format(data_format)
...
if __name__ =='__main__':
    net = Deeplabv3(input_shape=(512, 512, 3), classes=24, backbone='xception')
    net.summary()