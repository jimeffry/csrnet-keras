...
class BreathMask(object):
    ...
    def loadmodel(self,mpath):
        ...
        # print("********************end***************")
        self.input_image = self.sess.graph.get_tensor_by_name('faceattr_graph/images:0') #img_input
        self.conf_out = self.sess.graph.get_tensor_by_name('faceattr_graph/probs:0') #softmax_output
